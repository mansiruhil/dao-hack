...
import { QuizProgressSummary } from "@/components/quiz-progress-summary";
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#D0FFD0] font-mono relative">
      ...
      <Navbar />
      <nav className="mx-auto max-w-6xl px-4 py-4 text-sm flex items-center gap-6">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 sm:py-14">
        <h1 className="terminal-heading">
          {"> solmind — level-based quiz system"}
        </h1>
